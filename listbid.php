        ...
        <div class="row">
            <div class="col-lg-8 mb-5 mb-lg-0">
                <div class="form-title">
                    <h2 style="text-transform: capitalize">List Your Item For a auction or for a sale.</h2>
                    <p>You can place your listing from here. after you successfully list your waste item, you can see it
                        on our webpage for auction items. As well as you can see more options from your user
                        profile.</p>
                </div>
                <div id="form_status"></div>
                <div class="contact-form">
                    <form method="post" action="Actionlistbid.php" enctype="multipart/form-data">
                        <p>
                        ...
                        <p>
                            <input type="text" placeholder="Starting Value" name="bidStart" id="bidStart">
                        </p>
                        <p>
                        ...
                        <p><input type="submit" name="addBid" id="addBid" value="Submit"
