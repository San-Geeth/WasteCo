...
include './templates/heroarea.php';
include './templates/feature.php';
include './templates/homeproduct.php';
//include './templates/deal.php';
// include './templates/testominal.php';
include './templates/aboutvdo.php';
include './templates/adbanner.php';
