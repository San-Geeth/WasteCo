                ...
                <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <a class="" href="index.php">
                            <h6 class="text-primary"><i class="fa fa-hashtag me-2"></i>WASTECO Admin Panel</h6>
                        </a>
                    </div>
                    <form action="actionSignIn.php" method="post">
                        <div class="form-floating mb-3">
                            <input class="form-control" id="floatingInput" name="username" placeholder="User Name"
                                   type="text">
                        ...
                        <button class="btn btn-primary py-3 w-100 mb-4" name="signin" type="submit">Sign In</button>
                    </form>
