...
$sqlContactResult = mysqli_query($con, $sqlContact);
            ...
            <div class="bg-light text-center rounded p-4">
                ...
                <div class="table-responsive">
                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                        ...
                        <tr>
                            <?php
                            if (mysqli_num_rows($sqlContactResult) > 0) {
                            foreach ($sqlContactResult

                            as $rowContact) {
                            ?>
                        <tr>
                            <td><?php echo $rowContact['messageID']; ?></td>
                            ...
                            <td>
                                <form action="viewMessage.php" method="post">
                                    <input type="hidden" name="messageID"
                                           value="<?php echo $rowContact['messageID'] ?>">
                                    <input type="submit" name="viewMessage" class="btn btn-sm btn-primary"
                                           value="View">
                                </form>
                            </td>
                        </tr>
