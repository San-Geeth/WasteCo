...
if (isset($_POST['viewSeller'])) {
    $sellerID = $_POST['sellerID'];

    $sqlUser = "SELECT * FROM `user` WHERE `userID`='" . $sellerID . "'";
    $sqlUserResult = mysqli_query($con, $sqlUser);
    $rowUser = mysqli_fetch_assoc($sqlUserResult);
    $sellerName = $rowUser['name'];
                    ...
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input aria-describedby="emailHelp" class="form-control" id="exampleInputEmail1"
                                       type="text" value="<?php echo $contact ?>" disabled>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input aria-describedby="emailHelp" class="form-control" id="exampleInputEmail1"
                                       type="text" value="<?php echo $location ?>" disabled>
                            </div>
                        </form>
                    </div>
                </div>
