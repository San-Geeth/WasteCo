...
if (isset($_POST['addlist'])) {
    ...
    $sql = "SELECT * FROM sellp WHERE `sellID`='" . $id . "'";
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="single-product-img">
                    <img alt="" src="<?php echo "productImages/" . $image; ?>">
                </div>
            </div>
            <div class="col-md-7">
                ...
                <div class="single-product-content">
                    ...
                    <p class="single-product-pricing"><span><?php echo $qty ?></span> <?php echo $price ?></p>
                    <p><?php echo $detail ?></p>
                    <div class="single-product-form">
                        <form action="cart.php" method="post">
                            <input type="submit" name="addtoWhish" value="Add to WhishList">
                            <input type="hidden" name="listID" value="<?php echo $pid ?>">
                        </form>
                        ...
                        <p><i class="fas fa-map-marker"> <?php echo $location . ' ' ?></i> <i class="fas fa-user">
                                By <?php echo $seller . ' ' ?></i> <i
                                    class="fas fa-phone">  <?php echo $sellerContact ?></i>
                        </p>
                    </div>
                </div>
